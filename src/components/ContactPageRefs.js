  ...
  return (
    ...
    <img
      ...
      <div className="text-black">
        ...
        <p className="pt-1 pb-4" style={{ fontWeight: "600" }}>Andrea Perin / Titolare Arteba</p>
        <p>
...
<p>
        ...
        <p className="pt-1 pb-4" style={{ fontWeight: "600" }}>Giovanni Defendi / Consulente Materiali per Studi di Architettura</p>
      </div>
    </div>
  );
};
